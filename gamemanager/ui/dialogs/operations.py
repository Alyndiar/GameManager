...
from .common import TagReviewResult
...
class CleanupPreviewDialog(QDialog):
    def __init__(self, plan_items: list[RenamePlanItem], parent: QDialog | None = None):
        super().__init__(parent)
...
class MovePreviewDialog(QDialog):
    def __init__(self, plan_items: list[MovePlanItem], parent: QDialog | None = None):
        super().__init__(parent)
